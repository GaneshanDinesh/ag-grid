...
export const AG_GRID_LOCALE_RO = {
    ...
    advancedFilterReset: 'Resetare',
    advancedFilterCancel: 'Anulează',
    advancedFilterClear: 'Șterge',
    ...
    advancedFilterBuilderReset: 'Resetare',
    ...
    donut: 'Gogoașă',
    lineChart: 'Linie',
    stackedLine: 'Suprapus',
    normalizedLine: '100% Suprapus',
    ...
    lineTooltip: 'Linie',
    stackedLineTooltip: 'Suprapus',
    normalizedLineTooltip: 'Suprapus 100%',
    ...
    funnel: 'Pâlnie',
    coneFunnel: 'Pâlnie Con',
    pyramid: 'Piramidă',
    funnelGroup: 'Grup Pâlnie',
    funnelTooltip: 'Pâlnie',
    coneFunnelTooltip: 'Pâlnie Con',
    pyramidTooltip: 'Piramidă',
    dropOff: 'Coborâre',
    stageLabels: 'Etichete Etapă',
    reverse: 'Invers',
    tooltipMode: 'Modul Tooltip',
    tooltipModeSingle: 'Unic',
    tooltipModeShared: 'Multiplu',
