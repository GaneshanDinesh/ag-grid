...
export const AG_GRID_LOCALE_PK = {
    ...
    advancedFilterReset: 'ری سیٹ کریں',
    advancedFilterCancel: 'منسوخ کریں',
    advancedFilterClear: 'صاف کریں',
    ...
    advancedFilterBuilderReset: 'ری سیٹ کریں',
    ...
    donutTooltip: 'ڈونٹ',
    lineTooltip: 'لائن',
    stackedLineTooltip: 'مرتب',
    normalizedLineTooltip: '100% مرتب',
    ...
    funnel: 'قیف',
    coneFunnel: 'مخروطی قیف',
    pyramid: 'اہرام',
    funnelGroup: 'قیف',
    funnelTooltip: 'قیف',
    coneFunnelTooltip: 'مخروطی قیف',
    pyramidTooltip: 'اہرام',
    dropOff: 'کمی',
    stageLabels: 'مرحلے کے لیبلز',
    reverse: 'الٹا',
    tooltipMode: 'ٹول ٹپ موڈ',
    tooltipModeSingle: 'سنگل',
    tooltipModeShared: 'ملٹی پل',
    tooltipModeCompact: 'کمپیکٹ',
    ...
    ariaSelectAllCells: 'تمام سیلز کو منتخب کرنے کے لیے اسپیس دبائیں',
