...
export type ImportResult = { success: true; warnings: string[] } | { success: false; error: string };

export function executeThemeImport(code: string, store: Store): ImportResult {
